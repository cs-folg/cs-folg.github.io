...
<head>
  ...
  <title>Caio Folger – IT and Cybersecurity Undergraduate</title>
...
<body>
  ...
  <h2>Biography</h2>
  <div>
    <img src="Professional_picture.jpeg" alt="Professional Photoshoot">
    <p>
  ...
  <ul>
    ...
    <li>Scored highly (A or B+) in difficult courses such as Computer Science 1, Object Oriented Programming, and Physics 2</li>
  ...
  <dl>
    <dt><strong>Research Assistant and Machine Learning Model Maker</strong> | FSEC | May 2025 - present</dt>
    <dd>Built machine learning models to analyze large datasets and presented results in weekly meetings.</dd>

    <dt><strong>Event Volunteer</strong> | Plasticon | July 27th, 2024</dt>
    <dd>Used customer service skills to manage hundreds of incoming guests and distribute convention passes.</dd>

    <dt><strong>Retail Worker</strong> | Columbia Sportswear | February 2024 - May 2024</dt>
    <dd>Refined customer service and teamwork skills in various retail positions.</dd>

    <dt><strong>Food Service Worker</strong> | Steak N' Shake</dt>
    <dd>Developed team-building and time-management skills while serving customers.</dd>
  </dl>
</body>
</html>
